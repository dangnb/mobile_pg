...
class CheckInRepositoryImpl implements CheckInRepository{
  ...
  Future<CheckInResponse> CheckIn({required List<File> files, required String note}) async{
    ...
    return await checkInApi.checkIn(files, location.longitude, location.latitude, note, token).then((value){
      print(value);
      return  value;
    },onError: (e){
      print(e);
      return CheckInResponse(Id: 1, EmployeeCode: "EmployeeCode", Checkin: "Checkin", CheckIn_Longitude: 1.0000, CheckIn_Latitude: .00, CheckIn_Images: ["a","a"], CheckIn_Note: 'CheckIn_Note', CheckIn_ShopId: 2, CheckIn_ShopAddress: "CheckIn_ShopAddress", CheckOut: 'CheckOut', CheckOut_Longitude: 1.000, CheckOut_Latitude: 1.00, CheckOut_Images: ["a","a"], CheckOut_Note: "CheckOut_Note", CheckOut_ShopId: 2, CheckOut_ShopAddress: "CheckOut_ShopAddress", CheckDate: "CheckDate");
    });
  }
